...
\begin{document}
\name{
\Large{Yu Guo} ~~ \small{(update: 03/27/2026)} 
~~~~~~~~~~~~~~~~
...
\begin{resume}
	...
	My background is mainly focused on \textbf{Computer Graphics}, specially in \textbf{Physics-based Rendering}, \textbf{Inverse-rendering}, and \textbf{Material Capture and generation} using \textbf{GAN/Diffusion} model. Recently more focusing on \textbf{light/shadow} and material properties decomposition from 3D models (Mesh/\textbf{3DGS}) or 2D images, further make it \textbf{relightable} and \textbf{editable}. I am also interested in the projects related to \textbf{Meta Human}. See last page for some examples.    
...
%	\textbf{Thesis}: Forces Distribution with Fractal Theory in High Velocity Compaction Technology. \\
	...
	\textbf{Projects}:  \hfill \textbf{Sept. 2024 -- Mar. 2026} \\
	Physics-based images/videos generation and editing; Fine-tuning LMM for specific tasks.
	...
	- Product image generation: \textsl{We use fine-tuned Diffusion model to generate high quality image, and use image-based relighting technique to make the foreground and background lighting consistent.} \\
    ...
    \textbf{Projects}: Stereo rendering; Physical-based video manipulation; Virtual try-on system for eye-glasses. \\
    ...
    \href{http://www.py-laffont.info/}{P.Y Laffont},
	...
	(See full publication list in \href{https://scholar.google.com/citations?user=V2BnBGIAAAAJ&hl=en}{Google Scholar})

	``\textbf{Snapshot 3D Gaussian Splatting for Miniature Scenes}" 
	by Yufan Zhang, Yu Ji, \textbf{Yu Guo}, Jinwei Ye.
	\textsl{(to appear in TPAMI 2026)}\\

	\vspace{-5mm}	

	``\textbf{Pixel Cube: Diffusion-based Portrait Video Relighting Through Realistic Lighting Reproduction}" 
	by Yufan Zhang, Yu Ji, Ayo Ajiboye, Rundi Wu, \textbf{Yu Guo}, Changxi Zheng, Jinwei Ye.
	\textsl{(to appear in TOG 2026)}\\

	\vspace{-5mm}	

	``\textbf{Fiber-level Woven Fabric Capture from a Single Microscopic Image}" 
	by Zixuan Li, Pengfei Shen, Hanxian Sun, Zibo Zhang, \textbf{Yu Guo}, Ligang Liu, Lingqi Yan, Steve Marschner, Milos Hasan, Beibei Wang.
	\textsl{(to appear in TOG 2026)}\\

	\vspace{-5mm}	

	``\textbf{SIRR-LMM: Single-image Reflection Removal via Large Multimodal Model}" 
	by \textbf{Yu Guo}, Zhiqiang Lao, Xiyun Song, Yubin Zhou, Heather Yu.
	\textsl{(WACV 2026)}\\

	\vspace{-5mm}	

	``\textbf{Fluid Composer: Fluid Detail Composition and Rendering Using Video Diffusion Models}" 
	by Duowen Chen, Zhiqiang Lao, \textbf{Yu Guo}, Heather Yu.
	\textsl{(CGF 2025)}\\
